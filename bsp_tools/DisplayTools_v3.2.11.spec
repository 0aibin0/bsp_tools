...
#
# DisplayTools v3.2.11 打包配置（单文件 + 无控制台）
#
# 等价于命令行方式：
#   pyinstaller --onefile --noconsole --icon=icon_img/main.ico --name DisplayTools_v3.2.11 mainwindow.py
...
# （打包了会被解到临时目录，没法持久化）。
#
# 使用：pyinstaller DisplayTools_v3.2.11.spec
